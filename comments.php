	...
	comment_form(
		array(
            ...
            'fields' => array(
                ...
                'cookies' => '<input id="cookies" name="cookies" type="checkbox" class="form-checkbox bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5"/><label for="cookies" class="font-semibold text-sm text-gray-600 dark:text-gray-400 pb-1 block">' . __('Save my name, email, and website in this browser for the next time I comment.') . '</label>',
            )
		)
	);
	?>
