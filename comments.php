	...
	comment_form(
		array(
            ...
            'fields' => array(
                ...
                'cookies' => '<div class="flex items-start"> <input id="cookies" name="cookies" type="checkbox" class="form-checkbox bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-5 h-5 p-2.5"/> <label for="cookies">' . __('Save my name, email, and website in this browser for the next time I comment.') . '</label></div>',
            )
		)
	);
	?>
